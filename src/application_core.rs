...
use crate::{application_gui::ApplicationGUI, cpu1_controller::Cpu1Controller};
...
impl ApplicationCore {
	pub fn new(gui: ApplicationGUI, mio: FmMemoryIO, interrupt_bus: FmInterruptBus, cpu0_wakeup_handle: CpuWakeupHandle, cpu1_wakeup_handle: CpuWakeupHandle) -> Self {
